...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, use_gui):
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        for _ in range(opt.optimizer_step_interval):
            ...
            # Depth loss if depth is available
            Ll1depth_pure = 0.0
